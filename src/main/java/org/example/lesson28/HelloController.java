...
//        Arrays.fill(matrix_game, 0, 10, 0);
    }
...
//                fillGrid(currentI, currentJ, polygon.getFill());
...
//        Polygon polygon = new Polygon();
//        polygon.getPoints().addAll(0.0, 0.0, 49.0, 0.0, 49.0, 49.0, 0.0, 49.0);
