...
public class gameController implements Initializable {
    ...
    String[][] matrix_game = new String[10][10];
    ...
    private void createPolygon() {
        ...
        int i2 = rand.nextInt(255);
        polygon.setFill(Color.rgb(i, i1 , i2));
    ...
    private void setupDragHandlers(Polygon polygon) {
        ...
        polygon.setOnMouseReleased(event -> {
            ...
            int currentI = (int) ((currentX - 25) / 50);
            int currentJ = (int) ((currentY - 25) / 50);
            System.out.println(currentI + " " + currentJ);

            if (currentX < 525 && currentX > 25 && currentY < 525 && currentY > 25) {

                if( matrix_game[currentI][currentJ] != null){
                    polygon.setTranslateX(initialTranslateX[0]);
                    polygon.setTranslateY(initialTranslateY[0]);
                    return;
                }

                matrix_game[currentI][currentJ] = "is not null";
